...
def delete_cafe(cafe_id):
    ...
    if api_key == "TopSecretAPIKey":
        ...
        if cafe:
            ...
            db.session.commit()
            return jsonify(response={"Success": "Successfully deleted the cade from the database."}), 200
        else:
            return jsonify(error={"Not Found": "Sorry a cafe with id was not found in the database"}), 400
    else:
